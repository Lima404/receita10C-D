    ...
    return BottomNavigationBar(
      ...
      items: const [
        BottomNavigationBarItem(
          label: "Cafés",
          icon: Icon(Icons.coffee_outlined, color: Colors.purple),
        ),
        BottomNavigationBarItem(
          label: "Cervejas",
          icon: Icon(Icons.local_drink_outlined, color: Colors.purple),
        ),
        BottomNavigationBarItem(
          label: "Nações",
          icon: Icon(Icons.flag_outlined, color: Colors.purple),
        ),
      ],
    );
  }
